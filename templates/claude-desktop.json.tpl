{
  "$schema": "https://json.schemastore.org/claude-desktop.json",
  "version": "1.0.0",
  "description": "Claude Desktop MCP-Client-Konfiguration (Template). Wird von MCPConfig.psm1 pro Tool gemerged.",
  "mcpServers": {
    "context7": {
      "type": "stdio",
      "command": "npx",
